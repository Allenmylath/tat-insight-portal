-- Create view for paying customers (users with at least one completed purchase)
CREATE OR REPLACE VIEW public.paying_customers AS
SELECT 
  u.id as user_id,
  u.clerk_id,
  u.email,
...
COMMENT ON VIEW public.paying_customers IS 'View of all customers who have completed at least one purchase, with aggregated purchase statistics';